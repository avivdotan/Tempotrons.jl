...
"""
    VmaxLinked2Spike(spikes1, spikes2, v_max2)
Checks whether vₘₐₓ(θ₂) can be linked analitically to a spike generated by using
θ₁. Receives the spikes generated by θ₁ and θ₂, and the maximal subthreshold
local voltage maximum of θ₂.
"""
...
t⃰ (inclusive) and the unresetted voltage function `PSP`.
